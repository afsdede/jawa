...
if (isset($_GET['catId'])){
    echo $docController->listarDocumentoCategoriaAction($a->fixObject($_SESSION['userLogin']), $_GET['catId']);
}else {
    echo $docController->listarDocumentoCategoriaAction($a->fixObject($_SESSION['userLogin']));
}
?>