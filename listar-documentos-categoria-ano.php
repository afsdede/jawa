...
if (isset($_GET['catId'])){
    echo $docController->listarDocumentoCategoriaAnoAction($a->fixObject($_SESSION['userLogin']), $_GET['catId'], $_GET['ano']);
}else {
    echo $docController->listarDocumentoCategoriaAnoAction($a->fixObject($_SESSION['userLogin']));
}
?>